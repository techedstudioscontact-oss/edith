...
export const SignUp = () => {
    ...
    return (
        <div className="min-h-screen bg-dark-950 flex items-center justify-center p-4 relative overflow-hidden">
            ...
            <div className="absolute top-0 left-0 w-[500px] h-[500px] bg-primary/10 blur-[120px] rounded-full pointer-events-none animate-pulse" />
            <div className="absolute bottom-0 right-0 w-[500px] h-[500px] bg-primary/5 blur-[100px] rounded-full pointer-events-none animate-pulse" />
            ...
            >
                ...
                <div className="text-center mb-8 relative z-20">
                    ...
                    <h2 className="text-2xl font-bold text-white mb-2 mt-2">Create an Account</h2>
                    <p className="text-gray-400">Join the revolution of content creation.</p>
                </div>
                ...
                <form onSubmit={handleSignUp} className="space-y-4 relative z-20">
                    <div className="relative group/input">
                        <User className="absolute left-3 top-3 w-5 h-5 text-gray-500 group-focus-within/input:text-primary transition-colors" />
                        <input
                            type="text"
                ...
                <div className="mt-6 text-center text-sm text-gray-400 relative z-20">
                    ...
                    <Link to="/login" className="text-primary hover:text-primary-hover font-semibold hover:underline hover:text-glow transition-all">
                        Log In
                    </Link>
                </div>
            </motion.div>
